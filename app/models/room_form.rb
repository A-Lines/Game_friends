class RoomForm < ApplicationRecord
  ...
  def save
    @room = Room.create!(game_id: game_id, member_max: member_max, owner_id: owner_id,image_id: image, introduction: introduction, approval: approval,image_id: image_id,image_id: image)
        #byebug
    GameStyle.create!(room_id: @room.id,
                    platform_pc: platform_pc, platform_playstation: platform_playstation, platform_xbox: platform_xbox, platform_switch: platform_switch,platform_smartfone: platform_smartfone,
